...
const LeftDetails = () => {
  return (
    <div className="min-h-screen bg-[#FBF6F6] flex justify-center p-6">
      <div className="flex flex-col w-full max-w-64 gap-6">
        {" "}
        {/* دایو 1: اطلاعات دوره */}
        <div className="bg-white p-6 space-y-2 rounded-lg shadow-md text-[#12926C]">
          <h3>مدرس دوره : </h3>
          <p>هزینه تمام دوره : </p>
          <p>تکنولوژی دوره :</p>
          <p>سطح دوره :</p>
