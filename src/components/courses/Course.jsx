...
const Course = ({ data }) => {
  ...
  return (
    ...
    >
      ...
      <div className="pl-[2px] w-full flex flex-row flex-nowrap border border-black justify-start gap-6" >
      ...
      <div className="flex justify-between" >
        ...
        <button className="py-2.5 px-5 ml-[3px] text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 "
          onClick={() => navigate("/ProductDetail/" + courseId)}>
