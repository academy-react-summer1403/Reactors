        ...
        <form className="max-w-lg mx-auto ml-[-37rem] mt-2">
            <div className="flex ">
                <div className="relative w-full">
                    <input type="text" value={null} onChange={handleSearchChange} className="block p-2 w-72 ml-0 h-11 z-20 text-sm text-gray-900 bg-[#ffff] rounded-3xl border border-[#158B68]" placeholder="Search..." required />
