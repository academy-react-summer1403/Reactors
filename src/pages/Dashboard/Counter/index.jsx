...
import {
  getMyCourses,
  getUserInfo,
} from "../../../core/services/api/dashboard";
...
const Counter = () => {
  ...
  console.log(myCourses, "listOfMyCourses");
        ...
        <div className="flex gap-5 max-[1100px]:flex-wrap max-[1100px]:justify-center">
          ...
          <div className="flex flex-col gap-5 w-[55%] max-[1100px]:w-full">
            ...
            <div className="flex gap-5 justify-center max-[1400px]:flex-wrap max-[1100px]:flex-nowrap max-[650px]:flex-wrap">
              <ProfileProgress
                percentage={userProfile?.profileCompletionPercentage}
              />
              {myCourses?.listOfMyCourses.length === 0 ? null : (
                <CounterCourses
                  title="دوره های من"
                  responsive={"max-[1400px]:w-full"}
                  courseTitle={
                    myCourses ? myCourses?.listOfMyCourses[0].courseTitle : ""
                  }
                  teacher={
                    myCourses ? myCourses?.listOfMyCourses[0].fullName : ""
                  }
